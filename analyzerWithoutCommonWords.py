...
single_uses_count = word_frequency_counts[0]
single_use_percentage = single_uses_count/sum(word_frequency_counts)
print("Single use percentage: " + str(single_use_percentage * 100) + "%")
